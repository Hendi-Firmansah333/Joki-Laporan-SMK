      ...
      <section className="py-10 px-4 md:px-8">
        <div className="max-w-7xl mx-auto relative flex justify-center">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center p-2 sm:p-4 md:p-8 text-center z-10 pointer-events-none">
             {/* Shift right with ml-[10%] and lower with mt-[5%] */}
             <div className="flex flex-col items-center w-[60%] sm:w-[50%] md:w-[45%] lg:w-[40%] text-center pointer-events-auto ml-[10%] sm:ml-[15%] md:ml-[18%] lg:ml-[20%] mt-[2%] sm:mt-[4%] md:mt-[6%]">
               <h2 className="text-[10px] sm:text-sm md:text-xl lg:text-2xl xl:text-3xl font-extrabold mb-0.5 sm:mb-1 md:mb-2 text-white drop-shadow-md leading-tight">
                 Masih Bingung? Konsultasi <span className="text-[#00ffff]">Dulu Aja!</span>
               </h2>
               <p className="text-[6px] sm:text-[9px] md:text-xs lg:text-sm xl:text-base text-gray-100 mb-1 sm:mb-2 md:mb-4 font-medium drop-shadow leading-snug">
               ...
               <div className="flex flex-row gap-1 sm:gap-2 md:gap-3 lg:gap-4 justify-center w-full">
                 <a href="https://wa.me/6289507931092" target="_blank" rel="noopener noreferrer" className="flex items-center justify-between gap-1 sm:gap-1.5 bg-gradient-to-r from-green-400 to-green-600 hover:from-green-500 hover:to-green-700 text-white px-1.5 sm:px-3 md:px-4 py-1 sm:py-1.5 md:py-2 rounded-full font-bold transition-all hover:scale-105 shadow-lg shadow-green-500/30 border border-green-400/50 flex-1 min-w-0">
                   <div className="flex items-center gap-1 sm:gap-1.5 lg:gap-2 truncate">
                     <div className="bg-white text-green-500 rounded-full p-0.5 w-3 h-3 sm:w-5 sm:h-5 md:w-6 md:h-6 flex items-center justify-center shrink-0">
                       <MessageCircle className="w-2 h-2 sm:w-3 sm:h-3 md:w-4 md:h-4" fill="currentColor" />
                     </div>
                     <span className="text-[5px] sm:text-[7px] md:text-[10px] lg:text-xs text-left truncate">Chat via WhatsApp</span>
                   </div>
                   <ChevronRight className="w-2 h-2 sm:w-3 sm:h-3 md:w-4 md:h-4 opacity-80 shrink-0" />
                 </a>
                 <a href="https://www.instagram.com/jokikuy.laporanpkl/" target="_blank" rel="noopener noreferrer" className="flex items-center justify-between gap-1 sm:gap-1.5 bg-gradient-to-r from-[#f09433] via-[#dc2743] to-[#bc1888] hover:opacity-90 text-white px-1.5 sm:px-3 md:px-4 py-1 sm:py-1.5 md:py-2 rounded-full font-bold transition-all hover:scale-105 shadow-lg shadow-pink-500/30 border border-white/20 flex-1 min-w-0">
                   <div className="flex items-center gap-1 sm:gap-1.5 lg:gap-2 truncate">
                     <div className="bg-white text-[#dc2743] rounded-full p-0.5 w-3 h-3 sm:w-5 sm:h-5 md:w-6 md:h-6 flex items-center justify-center shrink-0">
                       <InstagramIcon className="w-2 h-2 sm:w-3 sm:h-3 md:w-4 md:h-4" />
                     </div>
                     <div className="text-left leading-tight truncate">
                       <div className="text-[5px] sm:text-[7px] md:text-[10px] lg:text-xs">DM Instagram</div>
                       <div className="text-[4px] sm:text-[5px] md:text-[7px] lg:text-[9px] font-normal opacity-90 truncate">@jokikuy.laporanpkl</div>
                     </div>
                   </div>
                   <ChevronRight className="w-2 h-2 sm:w-3 sm:h-3 md:w-4 md:h-4 opacity-80 shrink-0" />
                 </a>
